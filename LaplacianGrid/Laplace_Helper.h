...
public:
    explicit Laplace_Helper(T* const x_input,const T* const y_input, const unsigned long* const b_input,const int size_input)
        :x(x_input),y(y_input),b(b_input),size(size_input)
    {}
    void Run()
